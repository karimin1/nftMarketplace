...
const  AuthorNFTCardBox=({collectiables,created,like, follower, following})=> {
        const collectiablesArray=[images.nft_image_1,images.nft_image_2,images.nft_image_3]
    ...
    return (
        <div className={Style.AuthorNFTCardBox}>
           ...
           {collectiables &&  <div className={Style.AuthorNFTCardBox_box} ><NFTCardTwo  NFTData={collectiablesArray}/></div>}
           
            { created && <div className={Style.AuthorNFTCardBox_box}><NFTCardTwo  NFTData={createdArray}/></div> }
