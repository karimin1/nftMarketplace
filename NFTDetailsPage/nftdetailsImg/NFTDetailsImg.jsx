            ...
            <div className={Style.NFTDetailsImg_box}>
                ...
                </div>
                {
                    description && (
                        ...
                        <p>propmo ropmpor pooropm mroroir propmo ropmpor pooropm mroroir
                        propmo ropmpor pooropm mroroirpropmo ropmpor pooropm mroroir
                        propmo ropmpor pooropm mroroirpropmo ropmpor pooropm mroroir
                        propmo ropmpor pooropm mroroirpropmo ropmpor pooropm mroroir
                        propmo ropmpor pooropm mroroirpropmo ropmpor pooropm mroroir
                        propmo ropmpor pooropm mroroirpropmo ropmpor pooropm mroroir</p> 
                        </div>
                    )
                }
             ...
             {details && ( 
                    ...
                    <p>0x85d874df6d45fddfg7gh4rzgezrgergf4ffdf5465 </p>
                    </p>
                    <p> <small>Token ID</small></p>
                </div>
             )} 
            </div>
        </div>
