 ...
 const Profile = ()  =>{
    return (
        <div className={Style.profile}>
             ...
             <div className={Style.profile_menu_one_item}>
                <FaUserEdit/>
                <p><Link href={{pathname:'/myprofile'}}>Edit Profile</Link>
                </p>
             </div>
             ...
             <div className={Style.profile_menu_one_item}>
                <MdHelpCenter/>
                <p><Link href={{pathname:'/help'}}>Help</Link>
                </p>
             </div>
             </div>
             <div className={Style.profile_menu_one_item}>
                <TbDownload/>
                <p><Link href={{pathname:'/disconnect'}}>Discoonect</Link>
                </p>
             </div>
             </div>
       </div>
