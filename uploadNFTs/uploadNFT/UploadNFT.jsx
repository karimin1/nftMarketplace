    ...
    return (
        <div className={Style.upload}>
          <DropeZone title='JPG,PNG,MAX 100MB'
            ...
            itemName={itemName} website={website}
            description={description}
            royalties={royalties}
            fileSize={fileSize}
            category={category}
            propriety={propriety} image={images.upload}/>  
             <div className={Style.upload_box}>
                ...
                <div className={Style.upload_box_btn}>
                    ...
                    <Button   classStyle={Style.upload_box_btn_style} btnName='Uploadxx' handleClick={()=>{} }
                        
                    /> 

<Button   classStyle={Style.upload_box_btn_style} btnName='Preview' handleClick={()=>{} }
